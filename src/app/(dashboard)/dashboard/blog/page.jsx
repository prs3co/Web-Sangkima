              ...
              {data?.map((blog, index) => (
                <Table.Body className="divide-y" key={blog._id}>
                    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                      ...
                      <Table.Cell >
                        <div className='max-w-[144px] max-h-[144px] text-elipsis overflow-hidden'>
                          {parse(blog.content)}
                        </div>
                      </Table.Cell>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        <div className="flex flex-wrap gap-2">
                          ...
                          <div>
                          <button type="button" onClick={() => handleDelete(blog._id)} className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                            Delete
                          </button>
                            ...
                            className="focus:outline-nonetextbg-red-70hover:bg-red-800focus:ring-4 focus:ring-rfont-medium rounded-lgtext-spx-5 py-2.5mr-dark:bg-red-600dark:hover:bg-red-70dark:focus:ring-red-900">
                                Delete
                            </button> */}
                          </div>
                        </div>
